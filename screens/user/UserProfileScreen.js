...
const UserProfileScreen = (props) => {
    ...
    const renderSection = () => {
        return <View style={{ flexDirection: 'row', flexWrap: 'wrap' }}>{renderSectionOne()}</View>;
    };
                        ...
                        <View style={{ flex: 1, alignItems: 'center', justifyContent: 'flex-start' }}>
                            <Image
                                source={{
                                    uri:
                                        imageUri ||
                                        `${ENV.apiUrl}/user/photo/${currUser._id}?${new Date(currUser.updated)}`,
                                }}
                            ...
                            >
                                <View style={{ alignItems: 'center' }}>
                                    <TouchableComp
                                        background={
                                            Platform.OS === 'ios'
                                                ? undefined
                                                : TouchableNativeFeedback.Ripple('#c2c2c2', true)
                                        }
                                        onPress={() =>
                                            props.navigation.navigate('UserPosts', {
                                                userId: userId,
                                ...
                                <View style={{ alignItems: 'center' }}>
                                    <TouchableComp
                                        ...
                                        onPress={() =>
                                            props.navigation.navigate('UserStats', { activeTab: 0, currUser: currUser })
                                        }
                                    >
                                        <View style={{ justifyContent: 'center', alignItems: 'center' }}>
                                ...
                                <View style={{ alignItems: 'center' }}>
                                    <TouchableComp
                                        ...
                                        onPress={() =>
                                            props.navigation.navigate('UserStats', { activeTab: 1, currUser: currUser })
                                        }
                                    >
                                        <View style={{ justifyContent: 'center', alignItems: 'center' }}>
